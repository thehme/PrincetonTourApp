 ...
 */
public class CityAttractionFragmentPagerAdapter extends FragmentPagerAdapter {
    // context of app
    private Context mContext;

    public CityAttractionFragmentPagerAdapter(Context context, FragmentManager fm) {
        super(fm);
        mContext = context;
    }
